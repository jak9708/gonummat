...
[![go.dev reference](https://pkg.go.dev/badge/github.com/jak9708/gonummat)](https://pkg.go.dev/github.com/jak9708/gonummat)
[![GoDoc](https://godocs.io/github.com/jak9708/gonummat?status.svg)](https://godocs.io/github.com/jak9708/gonummat)
...
```
go get -u github.com/jak9708/gonummat/...
```
...
- tomita — use [Tomita, Tanaka, Takahashi pivot choice](https://doi.org/10.1016%2Fj.tcs.2006.06.015) for maximimal clique calculation, otherwise use random pivot (only in [topo package](https://pkg.go.dev/github.com/jak9708/gonummat/graph/topo))
