...
echo -e '// Code generated by "go generate github.com/jak9708/gonummat/blas/gonum”; DO NOT EDIT.\n' > level1float32.go
...
| sed -e "s_^\(func (Implementation) \)D\(.*\)\$_$WARNINGF32\1S\2_" \
      ...
      -e 's_^// Id_// Is_' \
      -e 's_"github.com/jak9708/gonummat/internal/asm/f64"_"github.com/jak9708/gonummat/internal/asm/f32"_' \
      -e 's_"math"_math "github.com/jak9708/gonummat/internal/math32"_' \
...
| sed -e "s_^\(func (Implementation) \)Zdot\(.*\)\$_$WARNINGC64\1Cdot\2_" \
      ...
      -e 's_^// Dz_// Sc_' \
      -e 's_"github.com/jak9708/gonummat/internal/asm/c128"_"github.com/jak9708/gonummat/internal/asm/c64"_' \
      -e 's_"math"_math "github.com/jak9708/gonummat/internal/math32"_' \
>> level1cmplx64.go
...
| sed -e "s_^\(func (Implementation) \)Z\(.*\)\$_$WARNINGC64\1C\2_" \
      -e 's_^// Z_// C_' \
      -e 's_"github.com/jak9708/gonummat/internal/asm/c128"_"github.com/jak9708/gonummat/internal/asm/c64"_' \
      -e 's_"math/cmplx"_cmplx "github.com/jak9708/gonummat/internal/cmplx64"_' \
>> level2cmplx64.go
